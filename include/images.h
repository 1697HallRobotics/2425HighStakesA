...
LV_IMG_DECLARE(frame_25);
LV_IMG_DECLARE(frame_26);
LV_IMG_DECLARE(frame_27);
LV_IMG_DECLARE(frame_28);
LV_IMG_DECLARE(frame_29);
LV_IMG_DECLARE(frame_30);
LV_IMG_DECLARE(frame_31);
LV_IMG_DECLARE(frame_32);
LV_IMG_DECLARE(frame_33);
